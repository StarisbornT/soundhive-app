...
class ServicesListScreen extends ConsumerStatefulWidget {
  ...
  const ServicesListScreen({super.key, required this.categoryName, required this.user});
...
class _ServicesListScreenState extends ConsumerState<ServicesListScreen>
  ...
  void didPopNext() {
    ...
    ref.read(getMarketplaceServiceProvider.notifier)
        .getMarketPlaceService(serviceName: widget.categoryName);
  }
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            ...
            ref.read(getMarketplaceServiceProvider.notifier)
                .getMarketPlaceService(serviceName: null); // Clear the category filter
