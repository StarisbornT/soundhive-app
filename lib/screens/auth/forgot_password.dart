...
class ForgotPassword extends StatefulWidget {
  ...
  final Dio dio;
  const ForgotPassword({super.key, required this.dio, required this.storage});
  ...
  Future<void> _saveFormData() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        Navigator.pushNamed(context, ForgotOtpScreen.id);
      }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildButton('Submit', const Color(0xFF4D3490)),
