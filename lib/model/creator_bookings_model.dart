...
class CreatorBookingsModel {
  ...
  CreatorBookingsModel({
    required this.status,
    required this.data,
    required this.stats,
  });

  factory CreatorBookingsModel.fromJson(String source) =>
      CreatorBookingsModel.fromMap(json.decode(source));

  factory CreatorBookingsModel.fromMap(Map<String, dynamic> map) {
    return CreatorBookingsModel(
      status: map['status'] ?? false,
      data: PaginatedBookingData.fromMap(map['data'] ?? {}),
      stats: BookingStats.fromMap(map['stats'] ?? {}),
    );
  }
}
...
class PaginatedBookingData {
  ...
  factory PaginatedBookingData.fromMap(Map<String, dynamic> map) {
    return PaginatedBookingData(
      ...
      data: List<Booking>.from(
          map['data']?.map((x) => Booking.fromMap(x)) ?? []),
